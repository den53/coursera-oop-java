...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// Select a map provider
		AbstractMapProvider providerForMap2 = new EsriProvider.WorldStreetMap();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2 = new UnfoldingMap(this, 410, 50, 350, 500, providerForMap2);
		map2.zoomAndPanTo(zoomLevel, new Location(48.1254563f, 11.5609157f));
		// This line makes the map interactive
